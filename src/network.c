...
#define OPTIMAL_BUFFER_SIZE 512
...
// send effect changes for client to display
...
int main(int argc, char *argv[])
{
    ...
    // create threads to stream audio send effect changes in parallel
    ...
    // check for effect changes while running server
